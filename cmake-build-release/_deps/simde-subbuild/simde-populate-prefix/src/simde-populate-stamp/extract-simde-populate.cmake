...
#
get_filename_component(filename "/Users/michele/Documents/GitHub/SegmentationFault/cmake-build-release/_deps/simde-subbuild/simde-populate-prefix/src/master.zip" ABSOLUTE)
get_filename_component(directory "/Users/michele/Documents/GitHub/SegmentationFault/cmake-build-release/_deps/simde-src" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-simde-populate${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-simde-populate${i}")
